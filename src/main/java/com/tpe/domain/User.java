...
@Entity
@Table(name = "t_user") //Burada tablo ismini user olarak bıraktığımızda SQL hata veriyor, o yüzden değiştirmek zorundayız.
@Getter
@Setter
@AllArgsConstructor
@NoArgsConstructor
public class User {
    ...
    @Column(length = 255, nullable = false) //password DB ye kaydedilmeden once sifrelenecegi icin
